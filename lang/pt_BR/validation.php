...
return [
		...
		| classe validadora. Algumas dessas regras têm várias versões, como as regras de
		...
		*/
		...
		|--------------------------------------------------------------------------
		|
		| Here you may specify custom validation messages for attributes using the convention
		| "attribute.rule" to name the lines. This makes it quick to specify a specific custom
		| language line for a given attribute rule.
		|
		*/
		...
		|--------------------------------------------------------------------------
		|
		| As linhas de linguagem a seguir são usadas para substituir nosso marcador de
		| posição de atributo por algo mais intuitivo, como "Endereço de e-mail" em vez
